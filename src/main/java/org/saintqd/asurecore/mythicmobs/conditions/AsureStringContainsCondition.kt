...
@MythicCondition(author = "SaintQd", name = "asurestringcontains")
class AsureStringContainsCondition(event : MythicConditionLoadEvent) : IEntityCondition, ILocationCondition, ISkillMetaComparisonCondition {
