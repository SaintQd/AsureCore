...
@MythicCondition(author = "SaintQd", name = "asurestringstartswith")
class AsureStringStartsWithCondition(event : MythicConditionLoadEvent) : IEntityCondition, ILocationCondition, ISkillMetaComparisonCondition {
