...
@MythicCondition(author = "SaintQd", name = "asuretemperature")
class AsureBlockTemperatureCondition(event : MythicConditionLoadEvent) : IEntityCondition, ILocationCondition {
